...
@Repository
class CaptiveJpaAuthorizationTokenRepositoryAdapter(
    private val jpaRepository: CaptiveAuthorizationTokenJpaRepository,
    private val mapper: CaptiveAuthorizationTokenMapper,
    ...
    override fun findByAccessCodeForAuthorization(accessCode: String): AuthorizationToken? =
        jpaRepository.findByAccessCodeForAuthorization(accessCode)?.let(mapper::tokenToDomain)
    ...
    override fun findAllAuthorizedMacs(): List<String> = jpaRepository.findAllAuthorizedMacs()
